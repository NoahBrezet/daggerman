...
def create_mon(new_id):
    if new_id != "□" and new_id != "C":
        if new_id == "K":
            ...
            create_monster(6+map.runscompleted, 4+2*map.runscompleted, 0, 3+map.runscompleted, "F")
        elif new_id == "L":
            ...
            if map.lvl < 6:
                create_monster(16+map.runscompleted*2, 6+2*map.runscompleted, 3, 7+map.runscompleted, "T")
            else:
                create_monster(16+map.runscompleted*2, 10+2*map.runscompleted, 4, 12+2*map.runscompleted, "T")
        elif new_id == "G":
            create_monster(10+map.runscompleted*3, 6, 4, 7, "G")
        elif new_id == "Ø":
            create_monster(20+map.runscompleted*2, 10, 2, 12, "Ø")
        elif new_id == "Ŧ":
            create_monster(50+map.runscompleted*10, 12+2*map.runscompleted, 4, 0, "Ŧ")
        elif new_id == "B":
            ...
            create_monster(30+map.runscompleted*5, 20, 10, 55, "D")
        elif new_id == "H":
            create_monster(20+map.runscompleted*5, 24, 8, 40, "H")
        elif new_id == "P":
            create_monster(10+map.runscompleted*4, 12+2*map.runscompleted, 15, 25+2*map.runscompleted, "P")
        elif new_id == "Ω":
            create_monster(100+map.runscompleted*20, 30+2*map.runscompleted, 15, 0, "Ω")
...
def longcave(xc, yc, M1, M2, gen):
    ...
    if gen == 1 or gen == 4:
        ...
        create_square(xc-1, yc-1, "□", 0)
        create_square(xc-1, yc+1, "□", 0)
        create_square(xc-2, yc-1, "□", 5)
        create_square(xc-2, yc+1, "□", 0)
        create_square(xc-2, yc-2, "C", 0)
        create_square(xc2, yc, M1, 0)
        create_mon(M1)
        create_square(xc2, yc-1, M2, 0)
        create_mon(M2)
        ...
        for dx, dy in ((1, 0), (-1, 0), (0, -1), (0, 1)):
            ...
            if newid == "□":
                if map.lvl <= 6:
                    ...
                    map.Mhp.append(10+map.runscompleted*4)
                    map.Mdamage.append(12)
                    map.Mdefense.append(15)
                    map.Mexp.append(25)
                    map.Mid.append("P")
                    map.MplaceID.append(place)
                    map.id[place] = "P"
    ...
    if map.lvl == 1:
        if room == 1:
            ...
            if map.runscompleted < 2:
                ...
                chestroom(xcentre, ycentre, "K", "K", gen)
        elif room == 6:
        ...
        if room == 1:
            ...
            if map.runscompleted < 2:
                ...
                longcave(xcentre, ycentre, "F", "S", gen)
        elif room == 5:
        ...
        if room == 5:
            if map.runscompleted < 2:
                ...
                longcave(xcentre, ycentre, "T", "□", gen)
        if room == 6:
        ...
        if room == 3:
            if map.runscompleted < 2:
                ...
                longcave(xcentre, ycentre, "Þ", "T", gen)
        if room == 4:
        ...
        if room == 3:
            chestroom(xcentre, ycentre, "D", "H", gen) 
        if room == 4:
            central(xcentre, ycentre, "P", "D", "□")
        if room == 5:
            longcave(xcentre, ycentre, "H", "P", gen)
        if room == 6:
            bosscave(xcentre, ycentre, "D", "H", gen)
    elif map.lvl == 10:
        bosscave(xcentre, ycentre, "Ω", "D", gen)